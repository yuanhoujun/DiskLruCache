...
public final class DiskLruCache implements Closeable {
  ...
  private static Serializable inputStreamToSerializable(InputStream in) throws IOException, ClassNotFoundException {
  ...
  public final class Editor {
    ...
    /**
     * Returns the last committed value as a serializable, or null if no value
     * has been committed.
     */
    public Serializable getSerializable(int index) throws IOException, ClassNotFoundException {
      InputStream in = newInputStream(index);
      return in != null ? inputStreamToSerializable(in) : null;
    }
    ...
    /** Sets the value at {@code index} to {@code value}. */
    public void set(int index, Serializable value) throws IOException {
      ObjectOutputStream writer = null;
      try {
        writer = new ObjectOutputStream(newOutputStream(index));
